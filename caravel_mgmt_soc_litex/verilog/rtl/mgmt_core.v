...
wire [1:0] dbg_uart_bytes_count = dbg_uart_data_bytes_count;
...
wire          mgmtsoc_irq;
reg           mgmtsoc_litespimmap0 = 1'd0;
reg           mgmtsoc_litespimmap1 = 1'd0;
reg    [29:0] mgmtsoc_litespimmap_burst_adr = 30'd0;
reg    [29:0] mgmtsoc_litespimmap_burst_adr_litespi_f_next_value = 30'd0;
reg           mgmtsoc_litespimmap_burst_adr_litespi_f_next_value_ce = 1'd0;
reg           mgmtsoc_litespimmap_burst_cs = 1'd0;
reg           mgmtsoc_litespimmap_burst_cs_litespi_next_value = 1'd0;
reg           mgmtsoc_litespimmap_burst_cs_litespi_next_value_ce = 1'd0;
...
reg     [1:0] mgmtsoc_litespimmap_byte_count = 2'd0;
reg     [1:0] mgmtsoc_litespimmap_byte_count_litespi_t_next_value = 2'd0;
reg           mgmtsoc_litespimmap_byte_count_litespi_t_next_value_ce = 1'd0;
reg     [8:0] mgmtsoc_litespimmap_count = 9'd256;
reg           mgmtsoc_litespimmap_cs = 1'd0;
reg    [31:0] mgmtsoc_litespimmap_data_write = 32'd0;
reg    [31:0] mgmtsoc_litespimmap_data_write_litespi_t_f_next_value1 = 32'd0;
reg           mgmtsoc_litespimmap_data_write_litespi_t_f_next_value_ce1 = 1'd0;
wire          mgmtsoc_litespimmap_done;
reg    [31:0] mgmtsoc_litespimmap_dummy = 32'd57005;
reg    [29:0] mgmtsoc_litespimmap_offset = 30'd0;
...
reg           mgmtsoc_litespimmap_write = 1'd0;
wire          mgmtsoc_litespimmap_write_enabled;
reg           mgmtsoc_litespimmap_write_litespi_t_t_next_value = 1'd0;
reg           mgmtsoc_litespimmap_write_litespi_t_t_next_value_ce = 1'd0;
reg     [3:0] mgmtsoc_litespimmap_write_mask = 4'd0;
reg     [3:0] mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value0 = 4'd0;
reg           mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value_ce0 = 1'd0;
...
always @(*) begin
    ...
    master[1] <= (shared_adr[29:8] == 1'd0);
    master[2] <= (shared_adr[29:7] == 2'd2);
    master[3] <= (shared_adr[29:22] == 5'd16);
    master[4] <= (shared_adr[29:26] == 2'd3);
    master[5] <= (shared_adr[29:20] == 8'd152);
...
assign mgmtsoc_vexriscv_debug_bus_cyc = (shared_cyc & master[0]);
assign dff_bus_cyc = (shared_cyc & master[1]);
assign dff2_bus_cyc = (shared_cyc & master[2]);
assign mgmtsoc_litespimmap_bus_cyc = (shared_cyc & master[3]);
assign mprj_cyc = (shared_cyc & master[4]);
assign hk_cyc = (shared_cyc & master[5]);
assign interface0_cyc = (shared_cyc & master[6]);
always @(*) begin
    shared_ack <= 1'd0;
    shared_ack <= ((((((mgmtsoc_vexriscv_debug_bus_ack | dff_bus_ack) | dff2_bus_ack) | mgmtsoc_litespimmap_bus_ack) | mprj_ack) | hk_ack) | interface0_ack);
    if (done) begin
        shared_ack <= 1'd1;
    end
end
assign shared_err = ((((((mgmtsoc_vexriscv_debug_bus_err | dff_bus_err) | dff2_bus_err) | mgmtsoc_litespimmap_bus_err) | mprj_err) | hk_err) | interface0_err);
always @(*) begin
    shared_dat_r <= 32'd0;
    shared_dat_r <= ((((((({32{slaves[0]}} & mgmtsoc_vexriscv_debug_bus_dat_r) | ({32{slaves[1]}} & dff_bus_dat_r)) | ({32{slaves[2]}} & dff2_bus_dat_r)) | ({32{slaves[3]}} & mgmtsoc_litespimmap_bus_dat_r)) | ({32{slaves[4]}} & mprj_dat_r)) | ({32{slaves[5]}} & hk_dat_r)) | ({32{slaves[6]}} & interface0_dat_r));
    if (done) begin
...
assign mgmtsoc_litespimmap_write_enabled = 1'd0;
...
always @(*) begin
    ...
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
                litespi_next_state <= 2'd2;
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
        ...
        3'd5: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                if ((mgmtsoc_litespimmap_write_enabled & mgmtsoc_litespimmap_write)) begin
        ...
        4'd11: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                if ((mgmtsoc_litespimmap_byte_count != 2'd3)) begin
                    if (mgmtsoc_litespimmap_write_mask[1]) begin
                        litespi_next_state <= 4'd10;
                    end else begin
        ...
        default: begin
            if ((mgmtsoc_litespimmap_bus_cyc & mgmtsoc_litespimmap_bus_stb)) begin
                if ((~mgmtsoc_litespimmap_bus_we)) begin
                    if (((mgmtsoc_litespimmap_burst_cs & (mgmtsoc_litespimmap_bus_adr == mgmtsoc_litespimmap_burst_adr)) & ((~mgmtsoc_litespimmap_write_enabled) | (~mgmtsoc_litespimmap_write)))) begin
                        litespi_next_state <= 4'd8;
                    end else begin
                        litespi_next_state <= 2'd2;
                    end
                end else begin
                    if (mgmtsoc_litespimmap_write_enabled) begin
                        if ((((mgmtsoc_litespimmap_burst_cs & (mgmtsoc_litespimmap_bus_adr == mgmtsoc_litespimmap_burst_adr)) & mgmtsoc_litespimmap_bus_sel[0]) & mgmtsoc_litespimmap_write)) begin
                            litespi_next_state <= 4'd10;
                        end else begin
                            litespi_next_state <= 1'd1;
                        end
...
always @(*) begin
    ...
    case (litespi_state)
        ...
        2'd2: begin
            if ((mgmtsoc_litespimmap_write_enabled & mgmtsoc_litespimmap_write)) begin
                mgmtsoc_litespimmap_source_payload_data <= 2'd2;
            end else begin
        ...
        3'd4: begin
            mgmtsoc_litespimmap_source_payload_data <= {(mgmtsoc_litespimmap_bus_adr - mgmtsoc_litespimmap_offset), mgmtsoc_litespimmap_byte_count};
        end
        3'd5: begin
        end
        3'd6: begin
        ...
        4'd10: begin
            mgmtsoc_litespimmap_source_payload_data <= mgmtsoc_litespimmap_data_write;
        end
        4'd11: begin
        end
        default: begin
...
always @(*) begin
    mgmtsoc_litespimmap_byte_count_litespi_t_next_value <= 2'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    ...
                    mgmtsoc_litespimmap_byte_count_litespi_t_next_value <= (mgmtsoc_litespimmap_byte_count + 1'd1);
                end
            end
        end
        2'd2: begin
        ...
        default: begin
            if ((mgmtsoc_litespimmap_bus_cyc & mgmtsoc_litespimmap_bus_stb)) begin
                mgmtsoc_litespimmap_byte_count_litespi_t_next_value <= 1'd0;
            end
        end
    endcase
end
...
always @(*) begin
    mgmtsoc_litespimmap_byte_count_litespi_t_next_value_ce <= 1'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    ...
                    mgmtsoc_litespimmap_byte_count_litespi_t_next_value_ce <= 1'd1;
                end
            end
        end
        2'd2: begin
...
always @(*) begin
    mgmtsoc_litespimmap_write_litespi_t_t_next_value <= 1'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
                mgmtsoc_litespimmap_write_litespi_t_t_next_value <= 1'd1;
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    mgmtsoc_litespimmap_write_litespi_t_t_next_value <= 1'd0;
                end else begin
...
always @(*) begin
    mgmtsoc_litespimmap_write_litespi_t_t_next_value_ce <= 1'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
                mgmtsoc_litespimmap_write_litespi_t_t_next_value_ce <= 1'd1;
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    mgmtsoc_litespimmap_write_litespi_t_t_next_value_ce <= 1'd1;
                end else begin
...
always @(*) begin
    mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value0 <= 4'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    ...
                    mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value0 <= {mgmtsoc_litespimmap0, mgmtsoc_litespimmap_write_mask[3:1]};
                end
            end
        end
        2'd2: begin
        ...
        4'd11: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                if ((mgmtsoc_litespimmap_byte_count != 2'd3)) begin
                    mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value0 <= {mgmtsoc_litespimmap1, mgmtsoc_litespimmap_write_mask[3:1]};
                end else begin
                end
            end
        end
        default: begin
            if ((mgmtsoc_litespimmap_bus_cyc & mgmtsoc_litespimmap_bus_stb)) begin
                if ((~mgmtsoc_litespimmap_bus_we)) begin
                    ...
                    if (mgmtsoc_litespimmap_write_enabled) begin
                        mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value0 <= mgmtsoc_litespimmap_bus_sel;
                    end
                end
            end
        end
...
always @(*) begin
    mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value_ce0 <= 1'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    ...
                    mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value_ce0 <= 1'd1;
                end
            end
        end
        2'd2: begin
...
always @(*) begin
    mgmtsoc_litespimmap_data_write_litespi_t_f_next_value1 <= 32'd0;
    case (litespi_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        4'd11: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                if ((mgmtsoc_litespimmap_byte_count != 2'd3)) begin
                    mgmtsoc_litespimmap_data_write_litespi_t_f_next_value1 <= (mgmtsoc_litespimmap_data_write >>> 4'd8);
                end else begin
                end
            end
        end
        default: begin
            if ((mgmtsoc_litespimmap_bus_cyc & mgmtsoc_litespimmap_bus_stb)) begin
                if ((~mgmtsoc_litespimmap_bus_we)) begin
                    ...
                    if (mgmtsoc_litespimmap_write_enabled) begin
                        mgmtsoc_litespimmap_data_write_litespi_t_f_next_value1 <= mgmtsoc_litespimmap_bus_dat_w;
                    end
                end
            end
        end
...
always @(*) begin
    mgmtsoc_litespimmap_data_write_litespi_t_f_next_value_ce1 <= 1'd0;
    case (litespi_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        4'd11: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                if ((mgmtsoc_litespimmap_byte_count != 2'd3)) begin
                    mgmtsoc_litespimmap_data_write_litespi_t_f_next_value_ce1 <= 1'd1;
                end else begin
                end
            end
        end
...
always @(*) begin
    mgmtsoc_litespimmap_burst_adr_litespi_f_next_value <= 30'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    mgmtsoc_litespimmap_burst_adr_litespi_f_next_value <= (mgmtsoc_litespimmap_burst_adr + 1'd1);
                end else begin
                end
            end
        end
        2'd2: begin
            mgmtsoc_litespimmap_burst_adr_litespi_f_next_value <= mgmtsoc_litespimmap_bus_adr;
        end
        2'd3: begin
        end
        3'd4: begin
...
always @(*) begin
    mgmtsoc_litespimmap_burst_adr_litespi_f_next_value_ce <= 1'd0;
    case (litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_write_mask[0]) begin
            end else begin
                if ((mgmtsoc_litespimmap_byte_count == 2'd3)) begin
                    mgmtsoc_litespimmap_burst_adr_litespi_f_next_value_ce <= 1'd1;
                end else begin
                end
            end
        end
...
always @(*) begin
    mgmtsoc_litespimmap_burst_cs_litespi_next_value <= 1'd0;
    case (litespi_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        3'd4: begin
            mgmtsoc_litespimmap_burst_cs_litespi_next_value <= 1'd1;
        end
        3'd5: begin
        end
        3'd6: begin
        ...
        default: begin
            mgmtsoc_litespimmap_burst_cs_litespi_next_value <= (mgmtsoc_litespimmap_burst_cs & (~mgmtsoc_litespimmap_done));
        end
    endcase
end
always @(*) begin
    mgmtsoc_litespimmap_burst_cs_litespi_next_value_ce <= 1'd0;
    case (litespi_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        3'd4: begin
            mgmtsoc_litespimmap_burst_cs_litespi_next_value_ce <= 1'd1;
        end
        3'd5: begin
        end
        3'd6: begin
...
assign csrbank3_mmap_dummy_bits0_w = mgmtsoc_litespimmap_storage;
...
always @(*) begin
    ...
    case (spi_master_mosi_sel)
        1'd0: begin
            sync_self <= spi_master_self[0];
        end
        1'd1: begin
            sync_self <= spi_master_self[1];
        end
        2'd2: begin
            sync_self <= spi_master_self[2];
        end
        2'd3: begin
            sync_self <= spi_master_self[3];
        end
        3'd4: begin
            sync_self <= spi_master_self[4];
        end
        3'd5: begin
            sync_self <= spi_master_self[5];
        end
        3'd6: begin
            sync_self <= spi_master_self[6];
        end
        default: begin
            sync_self <= spi_master_self[7];
        end
    endcase
end
...
always @(posedge sys_clk) begin
    ...
    if (mgmtsoc_litespimmap_burst_cs_litespi_next_value_ce) begin
        mgmtsoc_litespimmap_burst_cs <= mgmtsoc_litespimmap_burst_cs_litespi_next_value;
    end
    if (mgmtsoc_litespimmap_byte_count_litespi_t_next_value_ce) begin
        mgmtsoc_litespimmap_byte_count <= mgmtsoc_litespimmap_byte_count_litespi_t_next_value;
    end
    if (mgmtsoc_litespimmap_write_litespi_t_t_next_value_ce) begin
        mgmtsoc_litespimmap_write <= mgmtsoc_litespimmap_write_litespi_t_t_next_value;
    end
    if (mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value_ce0) begin
        mgmtsoc_litespimmap_write_mask <= mgmtsoc_litespimmap_write_mask_litespi_t_f_next_value0;
    end
    if (mgmtsoc_litespimmap_data_write_litespi_t_f_next_value_ce1) begin
        mgmtsoc_litespimmap_data_write <= mgmtsoc_litespimmap_data_write_litespi_t_f_next_value1;
    end
    if (mgmtsoc_litespimmap_burst_adr_litespi_f_next_value_ce) begin
        mgmtsoc_litespimmap_burst_adr <= mgmtsoc_litespimmap_burst_adr_litespi_f_next_value;
    end
    ...
    if (spi_master_mosi_latch) begin
        spi_master_self <= spi_master_mosi;
    ...
    if (csrbank3_mmap_dummy_bits0_re) begin
        mgmtsoc_litespimmap_storage <= csrbank3_mmap_dummy_bits0_r;
    end
    ...
    if (sys_rst) begin
        ...
        mgmtsoc_litespimmap_count <= 9'd256;
        mgmtsoc_litespimmap_write <= 1'd0;
        mgmtsoc_litespimmap_write_mask <= 4'd0;
        mgmtsoc_litespimmap_storage <= 8'd0;
        mgmtsoc_litespimmap_re <= 1'd0;
        mgmtsoc_litespimmap_data_write <= 32'd0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-01-07 21:25:46.
//------------------------------------------------------------------------------
